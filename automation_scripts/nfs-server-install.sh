...
sudo sed '1 a\/home           10.128.0.3(rw,sync,no_root_squash,no_subtree_check)' /etc/exports
sudo sed '2 a\/var/dev        10.128.0.3(rw,sync,no_subtree_check)' /etc/exports
sudo sed '3 a\/var/config        10.128.0.3(rw,sync,no_subtree_check)' /etc/exports
